#!/usr/bin/env python3
"""Collapse rerun MFQ results into persona–question means and dispersion.

Given a persona-conditioned MFQ CSV (e.g., `data/gpt-4o-mini.csv`) with
multiple repetitions per (persona, question), this script summarizes to one
row per (persona, question) containing:

- persona
- question
- average_score (mean over repetitions)
- standard_deviation (sample SD over repetitions, ddof=1)
