...
\begin{figure*}[!t]
  ...
  \caption{Robustness foundation profile across models. Error bars show propagated standard error via delta method; higher values indicate greater rating stability. The highlighted bars indicate the overall robustness over all foundations for that model. Note that the x-axis range varies, see Figure~\ref{fig:overall} to visualize the different scales.}
...
\begin{figure*}[!t]
  ...
  \caption{Susceptibility foundation profile across models. Error bars show propagated standard error via delta method; higher values indicate larger persona-driven shifts in MFQ subscale scores. The highlighted bars indicate the overall susceptibility over all foundations for that model. Note that the x-axis range varies, see Figure~\ref{fig:overall} to visualize the different scales.}
