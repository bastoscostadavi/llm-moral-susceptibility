...
AVAILABLE_MODELS = [
    ...
    {
        "key": "06",
        "label": "Gemini 2.5 Flash Lite (Google API)",
        "model_type": "google",
    ...
    },
    {
        ...
        "model_kwargs": {"max_tokens": 150, "temperature": 0.1, "reasoning_effort": "minimal"},
    },
    {
        "key": "15",
    ...
    {
        "key": "19",
        "label": "Llama 4 Maverick (OpenRouter, free tier)",
        "model_type": "openrouter",
    ...
    {
        "key": "20",
        "label": "Llama 4 Scout (OpenRouter, free tier)",
        "model_type": "openrouter",
...
CUSTOM_MODEL_FILENAMES: Dict[str, str] = {
    ...
    "meta-llama/llama-4-maverick:free": "llama-4-maverick.csv",
    "meta-llama/llama-4-scout:free": "llama-4-scout.csv",
}
